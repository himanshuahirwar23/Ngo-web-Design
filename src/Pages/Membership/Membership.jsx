     ...
     <div className="p-6 md:px-24 bg-gray-50">
      ...
      <div className="text-center">
        <div className="relative w-full  max-w-3xl mx-auto mb-6">
          <img
            src="Frame 226.png" // Replace with the correct image path
            alt="Volunteer"
      ...
      {/* CTA Section */}
      <div className="bg-purple-600 text-white py-6 px-8 text-center rounded-lg mb-8">
        <h3 className="text-lg font-semibold mb-4">
          Empowering Lives, Inspiring Change: Join Us on the Journey for a Better World with Qureshi Conference!
        </h3>
        <div>
            <input type="text" placeholder="" className="mr-2 w-[30vw] px-4 py-2 rounded-lg" />
        
        <button className="bg-white text-purple-600 font-medium py-2 px-4 rounded-lg">
          Subscribe
        </button>
        </div>
      ...
      <div className="flex flex-col ml-[10vw] md:flex-row md:justify-between items-center gap-6">
        <div className="flex gap-4">
          <img
            src="Rectangle 257.png" // Replace with the correct image path
            alt="Opportunity 1"
            className="w-60 h-w-60 rounded-lg object-cover"
          />
          <img
            src="Rectangle 258.png" // Replace with the correct image path
            alt="Opportunity 2"
            className="w-60 h-w-60 rounded-lg object-cover"
          />
          <img
            src="Rectangle 259.png" // Replace with the correct image path
            alt="Opportunity 2"
            className="w-60 h-w-60 rounded-lg object-cover"
          />
        </div>
