...
const Page1 = () => {
  return (
    <div className="flex flex-col gap-4 md:flex-row items-center  px-24 ">
      <div className="relative flex-shrink-0">
        <div className="absolute w-full h-full z-10  rounded-lg top-8 left-8"></div>
        <div className="flex flex-col gap-4  w-[50vw] h-[50vw]">
          <img
            src="Group 10.png"  
            alt="Helping Hands"
      ...
      <div className="max-w-lg space-y-4">
        <div>
        <h2 className="text-sm font-normal  mr-[347px] text-indigo-600">ABOUT US</h2>
        ...
        <div className="space-y-4">
          <div className="p-4 text-start	pb-8  bg-indigo-100 rounded-lg shadow-md">
            <h3 className="text-lg font-semibold pb-3 text-gray-800">Our Mission</h3>
          ...
          <div className="p-4 text-start pb-8 bg-indigo-100 rounded-lg shadow-md">
            <h3 className="text-lg font-semibold pb-3 text-gray-800">Our Vision</h3>
            <p className="text-gray-600">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor adipiscing elit, sed do eiusmod tempor.
            </p>
          </div>
